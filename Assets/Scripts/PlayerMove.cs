...
public class PlayerMove : MonoBehaviour
{
    ...
    private void PlayerQuarterViewWASD() //ÄõÅÍºä wasd ÀÌµ¿
    {
    ...
    private void PlayerQuarterViewMouseClick() // ÄõÅÍºä ¸¶¿ì½º Å¬¸¯ÀÌµ¿
    {
    ...
    private void PlayerFirstPersonViewWASD(Transform trasformangle) // 1ÀÎÄª ¸¶¿ì½º·Î È¸Àü wasdÀÌµ¿
    {
        float h = Input.GetAxisRaw("Horizontal");
        float v = Input.GetAxisRaw("Vertical");
        Vector3 moveDirection = new Vector3(h, 0, v).normalized;
